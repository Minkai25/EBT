...
from data.arc.trm.common import PuzzleDatasetMetadata, dihedral_transform, inverse_dihedral_transform
...
def convert_dataset(config: DataProcessConfig):
    ...
    for split_name, split in data.items():
        ...
        # print(split_name)
        # print(results['puzzle_identifiers'])
        # print(results['puzzle_indices'])
        # print(len(results['puzzle_indices']))
