...
class OriginalPuzzleDatasetConfig(pydantic.BaseModel):
    seed: int
...
class OriginalPuzzleDataset(IterableDataset):
    def __init__(self, config: OriginalPuzzleDatasetConfig, split: str = "train"):
        super().__init__()
        self.config = config
        self.split = split
    ...
    def _iter_train(self):
        for set_name, dataset in self._data.items():  # type: ignore
            ...
            self._iters += 1
            # print("Iteration in puzzle dataset", self._iters)
